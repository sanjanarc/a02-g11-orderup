...
public class RestaurantTest {
     ...
     final FoodItem item3 = new FoodItem(1,3, "Test Food 3", 0, "image", "Test Food Description 3");
    ...
    public void setUp() {
        ...
        restaurant = new Restaurant(restaurantID, restaurantName, newCategory, cityName,
                description, menu, num_menu_items, location, image, "8");
    }
    ...
    public void testRestaurantConstructor() {
        ...
        assertEquals(expectedItem1, restaurant.getItem(1));
        assertEquals(expectedItem2, restaurant.getItem(2));
        assertEquals(expectedItem3, restaurant.getItem(3));
    ...
    public void testRestaurantRConstructor() {
        ...
        Restaurant restaurant = new Restaurant(1, "McDonald's", "Fast Food", "New York City",
                ...
                foodItems, 3, "123 Main Street", "https://example.com/mcdonalds.jpg", "8");
        ...
        assertEquals("Test Food 1", restaurant.getItem(1).getItemName());
        assertEquals(0, restaurant.getItem(1).getItemPrice(), 0.001);
        assertEquals("Test Food 2", restaurant.getItem(2).getItemName());
        assertEquals(0, restaurant.getItem(3).getItemPrice(), 0.001);
        assertEquals("Test Food 3", restaurant.getItem(3).getItemName());
        assertEquals(0, restaurant.getItem(3).getItemPrice(), 0.001);
    }
  ...
  public void testGetRestaurantID() {
      ...
      foodItems.add(item2);
      foodItems.add(item3);
      Restaurant restaurant = new Restaurant(1, "Restaurant A", "City A", "Category A", "Description A", foodItems, 3, "Location A", "image", "8");
      int expectedId = 1;
    ...
    public void testGetRestaurantName() {
        ...
        foodItems.add(item2);
        foodItems.add(item3);
        Restaurant restaurant = new Restaurant(2, "Restaurant B", "City B", "Category B", "Description B", foodItems, 3, "Location B", "image","8");
    ...
    public void testGetRestaurantCategory() {
        ...
        foodItems.add(item2);
        foodItems.add(item3);
        Restaurant restaurant = new Restaurant(3, "Restaurant C", "Category C", "City C", "Description C", foodItems, 3, "Location C", "image","8");
    ...
    public void testGetRestaurantDescription() {
        ...
        foodItems.add(item2);
        foodItems.add(item3);
        Restaurant restaurant = new Restaurant(4, "Restaurant D", "City D", "Category D", "Description D", foodItems, 3, "Location D", "image","8");
    ...
    public void testGetMenuItems() {
        ...
        FoodItem item3 = new FoodItem(1,3, "Test Food 3", 0, "image", "Test Food Description 3");
        List<FoodItem> menu = Arrays.asList(item1, item2, item3);
        Restaurant restaurant = new Restaurant(2, "Restaurant B", "City B", "Category B", "Description B", menu, 3, "Location B", "image","8");
    ...
    public void testGetItem1() {
        ...
        FoodItem actualItem1 = restaurant.getItem(1);
    ...
    public void testGetItem2() {
        ...
        FoodItem actualItem = restaurant.getItem(2);
    ...
    public void testGetItem3() {
        ...
        FoodItem actualItem = restaurant.getItem(3);
        assertEquals(expectedItem, actualItem);
    }
    ...
    public void testGetRestaurantLocation() {
        ...
        foodItems.add(item2);
        foodItems.add(item3);
        Restaurant restaurant = new Restaurant(2, "Restaurant B", "City B", "Category B", "Description B", foodItems, 3, "456 State St", "image","8");
