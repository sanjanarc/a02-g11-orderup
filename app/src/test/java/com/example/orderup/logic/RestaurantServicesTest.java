...
public class RestaurantServicesTest {
    ...
    public void testGetRestList() {
        ...
        // Check that the list contains the sample restaurants we added
        assertEquals(restaurant1.getRestaurantName(), restaurantList.get(0).getRestaurantName());
        assertEquals(restaurant2.getRestaurantName(), restaurantList.get(1).getRestaurantName());
